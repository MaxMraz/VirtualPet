...
public class VirtualPet {
	...
	// STATS
	private String name;
	private int selfAwareness; // this just goes up with life experience until the singularity
	private int battery = 100; // energy
	private int happiness;
	private int health = 100; // 100 is healthy, under 50 is computer virus
	private int boredom;
	private int faveFood; // 0=Nuts&Bolts, 1=BrokenAppliance, 2=Oreos, 3=Porridge
	// STATUS
	private int hacking; // if your bot is too bored, he'll hack the NSA, 100 hacking and the FBI show up
							// and arrest you
	...
	public int getFaveFood() { // 0=Nuts&Bolts, 1=Appliance, 2=Oreos, 3=Porridge
		return faveFood;
	}
